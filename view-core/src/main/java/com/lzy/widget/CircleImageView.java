...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImageView_civ_BorderWidth, mBorderWidth);
        mBorderColor = a.getColor(R.styleable.CircleImageView_civ_BorderColor, mBorderColor);
        mBorderOverlay = a.getBoolean(R.styleable.CircleImageView_civ_BorderOverlay, mBorderOverlay);
        mFillColor = a.getColor(R.styleable.CircleImageView_civ_FillColor, mFillColor);
        a.recycle();
